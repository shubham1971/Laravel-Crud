...
<head>
    ...
    <link href="{{ asset('project/public/project/frontend/css/custom.css') }}" rel="stylesheet">
</head>
<body>
    <div id="app">
    ...
    <!-- Scripts -->
    <script src="{{ asset('project/public/frontend/js/bootstrap.bundle.min.js') }}" defer></script>
</body>
</html>
